 ...
 */
public class AsciidoctorTokenList implements TokenList {
  ...
  AsciidoctorTokenList(Document doc) {
    this.doc = doc;
    this.hidden = false;
  }
  ...
  public void setStartOffset(final int startOffset) {
    ...
    FileObject fileObject = FileUtil.getConfigFile("Spellcheckers/Asciidoctor");
